...
return [
    ...
    /*
    |
    | The menu that will be displayed in the <Sidebar /> component.
    | Split your menu items based on specific headings (follow the example below).
    |
    | - For the "route" only specify the route name as string. The <Sidebar /> component will use Ziggy route to bind your string.
    | - For the "icon" specify the full <svg> content of any HeroIcon https://heroicons.com/
    |
    */
    'sidebar' => [
        [
